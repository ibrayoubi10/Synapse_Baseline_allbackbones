# main_unext_2d_testvol.py
# Same structure as your UNet 2D main, but:
#  - Model = UNext
#  - Test split = "test_vol" evaluated as 2D slices extracted from volumes (same logic as your UNet main)
...
# CHANGE THIS IMPORT TO YOUR REAL PATH
from Ibrahim.networks.Unext_MultiLabel import UNext
...
def get_argparser():
    ...
    p.add_argument("--exp_name", type=str, default="Synapse_UNeXt_2D_testvol")
...
def main():
    ...
    # ===== Model: UNext =====
    model = UNext(num_classes=C, input_channels=3, img_size=opts.img_size).to(device)
    ...
    for epoch in range(opts.NB_EPOCH):
        ...
        _, train_macro = finalize_metrics(running_train, C)
        ...
        _, test_macro, test_losses = evaluate_on_test_2d(
