# main_resnet_2d_testvol.py
# Same structure as your UNet/UNeXt 2D main, but:
#  - Model is imported from your already-implemented file: ResNet_multilabel.py
...
# ============================================================
# IMPORT YOUR MODEL (already implemented elsewhere)
# IMPORTANT: adjust the import line to match YOUR project layout.
# If your file is: Ibrahim/networks/ResNet_multilabel.py -> this should work.
# ============================================================
from Ibrahim.networks.ResNet_MultiLabel import UNetWithResnet50Encoder
# OR if you want the 3-head model:
# from Ibrahim.networks.ResNet_multilabel import UNet_R50_3Heads_1Decoder
...
def _prep_2d_batch(images, labels, device):
    ...
    Accepts:
      ...
      - images (B,1,H,W)
      - images (B,3,H,W)
    ResNet encoder expects 3 channels, so if channel=1 => repeat to 3.
    """
    if images.dim() == 3:
...
def get_argparser():
    ...
    p.add_argument("--exp_name", type=str, default="Synapse_ResNet50UNet_2D_testvol")
...
def main():
    ...
    model = UNetWithResnet50Encoder(n_classes=C).to(device)
