...
"""
Partie Dataset - expects a specific folder structure with npz files for training 
and h5 files for evaluation. The lists_Synapse folder should contain text files listing the sample names for each split.
""" 
